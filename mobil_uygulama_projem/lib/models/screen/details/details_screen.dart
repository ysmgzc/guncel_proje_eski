...
import '../../../paketler/components/product.dart';
// sanaa taktiği öğreticem buiyi izle tmm hata alıunan importlar silinir hata alınan kodlar alt enter vurulur :))
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // sıra send e ben bunu biliydoum dfghoke bunları yap çalıştır tmmdır.d grş cok teşekkürlerr :))) dokunma lütfen djfkdn hahaa tmm
          Expanded(
            child: Container(
